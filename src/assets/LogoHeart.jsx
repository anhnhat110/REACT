...
export default function LogoHeart({ isFav, onClick }) {
  return (
    <div title="Like" className="heart-container" onClick={onClick}>
      <input id="Give-It-An-Id" className="checkbox" type="checkbox" checked={isFav} readOnly />
